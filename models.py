...
class Creature(Base):
    ...
    hit_points = Column(String)
    hit_dice = Column(String)
    fortitude = Column(String)
    ...
    base_attack = Column(String)
    base_attack_modifier = Column(String)
    combat_maneuver_bonus = Column(String)
    combat_maneuver_bonus_modifier = Column(String)
    combat_maneuver_defense = Column(String)
...
class CreatureDamageReductionModifiers(Base):
    ...
    reduction_amount = Column(String)
